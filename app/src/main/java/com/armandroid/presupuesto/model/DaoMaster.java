...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        TdcDao.createTable(db, ifNotExists);
        BudgetDao.createTable(db, ifNotExists);
        MoneyEntryDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        TdcDao.dropTable(db, ifExists);
        BudgetDao.dropTable(db, ifExists);
        MoneyEntryDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(TdcDao.class);
        registerDaoClass(BudgetDao.class);
        registerDaoClass(MoneyEntryDao.class);
